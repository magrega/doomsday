...
const ChildModal: FC = () => {
  ...
  return (
    <>
      <a onClick={handleOpen} className='navbar__a' href='/' >craft your story <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <div className="modal-window__top">
          ...
          {/* <input type="text" value={`Rebels fear loss of human autonomy with AGI. As they hack into the supercomputers, they realize singularity may be humanity's only hope.`}/> */}
          <p className='generate-result'>
          Rebels fear loss of human autonomy with AGI. As they hack into the supercomputers, they realize singularity may be humanity's only hope.
          </p>
          <ShareStory/>
        </Box>
      </Modal>
